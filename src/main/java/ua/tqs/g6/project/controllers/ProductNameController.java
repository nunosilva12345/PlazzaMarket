...
public class ProductNameController
{
	...
	@ApiOperation(value = "Add productName to database")
	@PostMapping(consumes = "application/json")
	public @ResponseBody ProductName create(@RequestBody ProductName productName)
	{
		return productNameRepository.saveAndFlush(productName);
	}
