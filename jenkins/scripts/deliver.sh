...
scp -i /root/.ssh/id_rsa target/${NAME}-${VERSION}.jar tqs@192.168.160.77:~/target/
...
ssh -i /root/.ssh/id_rsa tqs@192.168.160.77 'nohup docker run -p 8080:8080 --name plazzamarket plazzamarket/app &'